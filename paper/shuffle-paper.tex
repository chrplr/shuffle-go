...
but can produce sequences that are practically problematic. Long runs of
...
I developed standalone versions of the shuffling utility. An
\texttt{awk} implementation was produced first, followed by a
\texttt{Perl} version equipped with a Tk graphical interface, which
was used by a number of researchers. Nevertheless, these versions
